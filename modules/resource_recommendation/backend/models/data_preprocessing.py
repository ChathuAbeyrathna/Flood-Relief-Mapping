...
class ReliefDataPreprocessor:
    ...
    def load_data(self):
        ...
        rename_map = {
            'Children_Pct': 'Children_%', 'Elderly_Pct': 'Elderly_%',
            'Cooked_Food_Packs': 'Cooked Food Packs', 'Water_Bottles': 'Water Bottles',
            'Milk_Powder_Packs': 'Milk Powder Packs', 'Infant_Milk_Powder_Packs': 'Infant Milk Powder Packs',
            'Biscuits_Packs': 'Biscuits Packs', 'Noodles_Packs': 'Noodles Packs',
