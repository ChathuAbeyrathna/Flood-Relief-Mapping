...
class ReliefDatabase:
    ...
    def get_flood_severity(self, division_name, event_date=None):
        ...
        if self.client is None:
            print(f"No Supabase connection, using default 'Medium'")
            return 'Medium'
        ...
        try:
            ...
            if response.data and len(response.data) > 0:
                ...
                print(f"No flood data for {division_name}, using default 'Medium'")
                return 'Medium'
                
        except Exception as e:
            print(f"Error getting flood severity: {e}")
            return 'Medium'
    ...
    def get_population_data(self, division_name, event_date=None):
        ...
        try:
            ...
            print(f"Error reading Module 2: {e}")
    ...
    def save_prediction(self, division_name, input_data, predictions, overall_priority, explanation, event_date=None):
        ...
        """
        if self.client is None:
            print(f"Cannot save: No Supabase connection")
            return False
